# Learn About Supplementary Activities for Schools in Your Area — Puerto Princesa City

This guide shows where to find **clubs, student organizations, competitions, service groups, and enrichment programs** available to learners in Puerto Princesa City.
...
2. **DepEd Schools Division Office of Puerto Princesa City** — division-wide contests, trainings, and circulars:
   - Website: https://depedpuertoprincesa.ph/
   - FB page: https://www.facebook.com/DepEdPuertoPrincesaCity/
3. **City facilities** — the **Puerto Princesa City Library (Mendoza Park, Rizal Avenue)** runs study support and computer/printing access (open daily until 10:00 p.m., including weekends and holidays):
   - Palawan News article: https://palawan-news.com/city-library-now-has-starlink-wifi-and-its-open-until-10-p-m-every-day/
...
| **Campus Journalism (School Papers)**                     | Writing, editing, layout, radio/TV script, participation in press conferences       | Start with your English/Filipino department; division circulars are posted on the DepEd Puerto Princesa site/FB                    |
...
- **ALS (Alternative Learning System)** — if you're out-of-school youth or need flexible learning.
  - DepEd Puerto Princesa Division contact page lists ALS focal persons: https://depedpuertoprincesa.ph/
- **City Library Programs** — occasional **digital skills** and study support activities (ask staff at the City Library, Mendoza Park).
...
5. **Track division-level announcements** via DepEd Puerto Princesa for contests and training invitations.
...
- DepEd Schools Division of Puerto Princesa City — https://depedpuertoprincesa.ph/
- DepEd Puerto Princesa FB — https://www.facebook.com/DepEdPuertoPrincesaCity/
- Puerto Princesa City Library news — https://palawan-news.com/city-library-now-has-starlink-wifi-and-its-open-until-10-p-m-every-day/
